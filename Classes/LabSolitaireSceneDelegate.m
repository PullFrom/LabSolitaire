// =====================================================================================================================
//  LabSolitaireSceneDelegate.m
// =====================================================================================================================


#import "LabSolitaireSceneDelegate.h"
#import "LabSolitaireViewController.h"


@implementation LabSolitaireSceneDelegate
{
...
- (void) scene: (UIScene *) scene willConnectToSession: (UISceneSession *) session options: (UISceneConnectionOptions *) connectionOptions
{
    ...
    _viewController = [[LabSolitaireViewController alloc] initWithNibName: @"LabSolitaireViewController" bundle: nil];
